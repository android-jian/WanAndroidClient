package top.androidjian.androidlearnclient.ui.fragment
...
import top.androidjian.androidlearnclient.adapter.BannerAdapter
import top.androidjian.androidlearnclient.adapter.HomeAdapter
import top.androidjian.androidlearnclient.base.BaseFragment
import top.androidjian.androidlearnclient.base.Preference
import top.androidjian.androidlearnclient.bean.BannerResponse
import top.androidjian.androidlearnclient.bean.Datas
import top.androidjian.androidlearnclient.bean.HomeListResponse
import top.androidjian.androidlearnclient.presenter.HomeFragmentPresenterImpl
import top.androidjian.androidlearnclient.ui.activity.ContentActivity
import top.androidjian.androidlearnclient.ui.activity.LoginActivity
import top.androidjian.androidlearnclient.ui.activity.TypeContentActivity
import top.androidjian.androidlearnclient.ui.view.HorizontalRecyclerView
import top.androidjian.androidlearnclient.view.CollectArticleView
import top.androidjian.androidlearnclient.view.HomeFragmentView
...
class HomeFragment : BaseFragment(), HomeFragmentView, CollectArticleView {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        swipeRefreshLayout.run {
            //设置全局的Header构建器
            setRefreshHeader(DeliveryHeader(activity))
            autoRefresh()
